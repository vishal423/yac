 ...
 */
public class GitYacModule extends CoreYacModule {

    public GitYacModule(YacTemplateServiceFactory templateServiceFactory,
    ...
    protected YacTemplateConfig configureTemplates(Application application) {
        System.out.println("Configure git template files ...");
        return new GitYacTemplateConfig(application);
    }
}
